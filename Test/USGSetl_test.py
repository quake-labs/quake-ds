...
<<<<<<< HEAD:USGSetl_test.py
    def test_get_recent(self):
        production_url = 'https://quake-ds-production.herokuapp.com/test'
        recent = get_recent_quakes(production_url)
...
>>>>>>> flaskandPipeline:Test/USGSetl_test.py
